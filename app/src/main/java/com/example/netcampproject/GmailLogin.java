...
public class GmailLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setBackgroundDrawableResource(R.drawable.gm);
        ...
        GoogleSignInOptions googleSignInOptions = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken("371199397543-mc8k4en2h6hogml39869uhqfumqkc2jk.apps.googleusercontent.com").requestEmail().build();
